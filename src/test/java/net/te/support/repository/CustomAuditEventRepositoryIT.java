package net.te.support.repository;

import net.te.support.SupportApp;
import net.te.support.config.Constants;
import net.te.support.config.audit.AuditEventConverter;
import net.te.support.domain.PersistentAuditEvent;
...
import static net.te.support.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
